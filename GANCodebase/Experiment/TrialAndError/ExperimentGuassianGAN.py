...
# Save model
saveGeneratorModelPath = "./Model/TrainedModel/GuassianGAN/Generator" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
saveDiscriminatorModelPath = "./Model/TrainedModel/GuassianGAN/Discriminator" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
...
plt.xlim(-3,3)
plt.ylim(-3,3)
saveFigPath = "./Figure/Experiment/TrialAndError/ExperimentGuassianGAN/GeneratedImage_5x5" + "_dim" \
...
saveFigPath = "./Figure/Experiment/TrialAndError/ExperimentGuassianGAN/EpochLossPlot" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".png"
CreateFile(saveFigPath)
plt.savefig(saveFigPath) # Save viz
plt.show()
