...
saveFigPath = "./Figure/Experiment/MNIST/AltGDA/GeneratedImage_5x5" + "_dim" \
...
saveFigPath = "./Figure/Experiment/MNIST/AltGDA/EpochLossPlot" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".png"
CreateFile(saveFigPath)
plt.savefig(saveFigPath) # Save viz
plt.show()
