...
from Algorithm.SimGDA import SimGDA
...
# Save model
saveGeneratorModelPath = "./Model/TrainedModel/MnistGAN/SimGDA/Generator" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
saveDiscriminatorModelPath = "./Model/TrainedModel/MnistGAN/SimGDA/Discriminator" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
...
saveFigPath = "./Figure/Experiment/MNIST/MnistGAN_SimGDA/GeneratedImage_5x5" + "_dim" \
...
saveFigPath = "./Figure/Experiment/MNIST/MnistGAN_SimGDA/EpochLossPlot" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".png"
CreateFile(saveFigPath)
plt.savefig(saveFigPath) # Save viz
plt.show()
