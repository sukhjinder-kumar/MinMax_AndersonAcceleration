...
# Save model
saveGeneratorModelPath = "./Model/TrainedModel/GuassianGAN/SimGDA/Generator" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
saveDiscriminatorModelPath = "./Model/TrainedModel/GuassianGAN/SimGDA/Discriminator" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
...
# plt.xlim(-3,3)
# plt.ylim(-3,3)
saveFigPath = "./Figure/Experiment/GUASSIAN/GuassianGAN_SimGDA/ScatterPlot" + "_dim" \
...
saveFigPath = "./Figure/Experiment/GUASSIAN/GuassianGAN_SimGDA/EpochLossPlot" + "_dim" \
    + str(dim) + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".png"
CreateFile(saveFigPath)
plt.savefig(saveFigPath) # Save viz
plt.show()
