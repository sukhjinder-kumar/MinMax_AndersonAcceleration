...
from Dataset.LoadNormalData import normal10DimTrainDs, normal10DimTestDs
...
# Save model
saveGeneratorModelPath = "./Model/TrainedModel/TestGAN/Generator.pt" + "_dim10" \
    + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
saveDiscriminatorModelPath = "./Model/TrainedModel/TestGAN/Discriminator.pt" + "_dim10" \
    + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".pt"
...
saveFigPath = "./Figure/Experiment/VerifySetup/GAN/GeneratedImage" + "_dim10" \
    + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".png"
...
saveFigPath = "./Figure/Experiment/VerifySetup/GAN/EpochLossPlot" + "_dim10" \
    + "_batchSize" + str(batchSize) + "_numEpochs" + str(numEpochs) + ".png"
CreateFile(saveFigPath)
plt.savefig(saveFigPath) # Save viz
plt.show()
